...
#
checkpoint_save_path = './pytorch_space/cassava_senet154.pth'
...
# Train and evaluate
model_ft, hist = train_model(model_ft, dataloaders_dict, criterion, optimizer_ft, device, checkpoint_save_path, num_epoch_to_stop_if_no_better,
                             num_epochs=num_epochs, is_inception=(model_name == "inception"), is_resume=False)
